...
<?php
    ...
    $jsLibraries = array("React", "Angular", "Vue");

    print_r($jsLibraries);  //Array([0]=>React [1]=>Angular [2]=>Vue)
    echo '<br>';
    var_dump($jsLibraries); //array(3) {[0]=> string(5) "React" [1]=> string(7) "Angular" [2]=>string(3) "Vue"}

    echo $jsLibraries[1];   //Angular
    ...
    var_dump($jsLibraries);

    echo '<h3>' . $jsLibraries["React"] . '</h3>';
